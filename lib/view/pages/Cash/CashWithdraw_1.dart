...
class CashWithdraw_1 extends StatefulWidget {
  const CashWithdraw_1({Key? key}) : super(key: key);

  @override
  State<CashWithdraw_1> createState() => _CashWithdraw_1State();
}

class _CashWithdraw_1State extends State<CashWithdraw_1> {
            ...
            children: [
              ...
              Padding(padding: const EdgeInsets.symmetric(horizontal: 32),
                child: Button(
                    text: 'Continue',
                    onTap: () {
                      AppRouter.goTo(screenName: ScreenName.CashWithdraw_2);
                    },
